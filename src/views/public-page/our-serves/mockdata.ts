const servesData = [
  {
    ...
    title_en: "Accounting & Bookkeeping",
    title_ar: "المحاسبة ومسك الدفاتر",
    desc_en:
  ...
  {
    src: "/tax-1.jpg",
    title_en: "Tax accounting",
    title_ar: "المحاسبة الضريبية",
    desc_en:
  ...
  {
    src: "/establish.jpg",
    title_en: "Establishing Corporations",
    title_ar: "تأسيس الشركات",
    desc_en:
      "<ul><li>	Establishing, amending, dissolving and liquidating companies of all kinds, as well as individual establishments.</li><li>	Registration and deregistration in value added taxes.</li><li>	Enrollment in the records of importers, exporters and commercial agents in the General Authority for Export and Import Control.</li><li>	Opening and closing social insurance files and carrying out all related work.</li></ul>",
    desc_ar:
      "<ul><li>تأسيس وتعديل وحل وتصفية الشركات على اختلاف أنواعها والمؤسسات الفردية. </li><li>التسجيل وإلغاء التسجيل في ضرائب القيمة المضافة.</li><li>القيد بسجلات المستوردين والمصدرين والوكلاء التجاريين بالهيئة العامة للرقابة على الصادرات والواردات. </li><li>فتح وإغلاق ملفات التأمينات الاجتماعية والقيام بجميع الأعمال المتعلقة بها. </li><li>تأسيس الشركات في اقل فترة زمنية بما تمتلكه من خبرات ، وقد تم اكتساب تلك الخبرات من خلال تأسيس العديد من شركات الأشخاص والشركات المساهمة</li></ul>",
  },
  {
    src: "/tax-2.jpg",
    ...
    desc_en:
      "<ul><li>Our office provides tax consulting services to our corporate clients from the beginning of preparing tax examination documents, attending a tax examination to clarify the company’s point of view and avoiding tax disputes from the beginning of the examination. </li><li>	Follow-up on appeals procedures, attendance of internal committees and appeals committees, 	and ensuring that company procedures and tax examination procedures are consistent within the framework of relevant tax laws. </li><li>The work of the committees necessary for tax accounting in orders and reaching the best results for clients.</li><li>Follow up on what is referred to the public tax appeals committees or the value-added tax grievance committees and provide the necessary defense on a professional and objective basis to obtain the best decisions for clients.</li><li>Follow up on tax or financial cases that are considered by the courts for clients and appear before the expert office and provide the necessary defense on a professional and objective basis to obtain the best rulings for clients.</li><li>Prepare files to obtain funds for all projects.</li></ul>",
    desc_ar:
      "<ul><li>يقدم مكتبنا خدمات الاستشارات الضريبية لعملائنا من الشركات من بداية إعداد مستندات الفحص الضريبي وحضور الفحص الضريبي لتوضيح وجهة نظر الشركة وتجنب المنازعات الضريبية من بداية الفحص ومتابعة إجراءات الاستئناف والحضور اللجان الداخلية ولجان الاستئناف ، </li><li>والتأكد من أن إجراءات الشركة وإجراءات الفحص الضريبي متسقة في إطار قوانين الضرائب ذات الصلة</li><li>عمل اللجان اللازمة للمحاسبة الضريبية بالطلبات والوصول لأفضل النتائج للعملاء. </li><li>   متابعة ما يحال إلى لجان الطعن الضريبي العامة أو لجان تظلم ضريبة القيمة المضافة وتقديم الدفاع اللازم على أساس مهني وموضوعي للحصول على أفضل القرارات للعملاء. </li><li>متابعة القضايا الضريبية أو المالية التي تنظر فيها المحاكم للعملاء والمثول أمام مكتب الخبراء وتقديم الدفاع اللازم على أساس مهني وموضوعي للحصول على أفضل الأحكام للعملاء.</li><li> تجهيز الملفات للحصول على الأموال لجميع المشاريع.</li></ul>",
  },
  {
    src: "/training.jpg",
    title_en: "Accounting and tax Training",
    title_ar: "التدريب على المحاسبة والضرائب",
    desc_en:
  ...
  },
  {
    ...
    title_ar: "خدمات حكومية",
    desc_en:
      "<ul><li>	We can assist you in dealing with the Ministry of Investment, Capital Market Authority, and other government authorities.</li><li>We will help you to prepare the necessary documents, submit the required reports, and follow up on your applications. </li><li>	We will also represent you in meetings and negotiations with government officials.</li></ul>",
    desc_ar:
      "<ul><li> يمكننا مساعدتك في التعامل مع وزارة الاستثمار وهيئة سوق المال والسلطات الحكومية الأخرى.</li><li> سنساعدك في إعداد المستندات اللازمة وتقديم التقارير المطلوبة ومتابعة طلباتك.</li><li> سنمثلك أيضًا في الاجتماعات والمفاوضات مع المسؤولين الحكوميين</li></ul>",
  },
];

export default servesData;
